...
export function DownloadSection() {
  return (
    <section className="min-h-[50vh] flex flex-col items-center justify-center px-6 py-20 pb-32">
      <div className="flex flex-col items-center justify-center space-y-8">
        ...
        <motion.a
          ...
          viewport={{ once: true }}
          className="group relative flex flex-row items-center gap-4 md:gap-6 px-6 py-5 md:px-8 md:py-6 bg-matrix-green/5 border border-matrix-green/50 hover:bg-matrix-green/10 text-matrix-green font-mono text-base md:text-lg transition-all overflow-hidden"
        >
          {/* Scanline effect */}
